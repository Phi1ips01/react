...
import {instance as getBusOperator,postInstance as postBusOperator, deleteInstance as deleteBusOperator,updateInstance as updateBusOperator,showOneInstance as showOneBusOperator,getTotalInstance as getTotalBusOperator} from './busOperatorAPI'
